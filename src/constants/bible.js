...
export const BIBLE_BOOKS = [
  ...
  // Major Prophets
  { id: 'is',   name: 'Isaiah',         slug: 'isaiah',         testament: 'OT', chapters: 66,  group: 'Major Prophets' },
  { id: 'jr',   name: 'Jeremiah',       slug: 'jeremiah',       testament: 'OT', chapters: 52,  group: 'Major Prophets' },
  { id: 'lm',   name: 'Lamentations',   slug: 'lamentations',   testament: 'OT', chapters: 5,   group: 'Major Prophets' },
  { id: 'ez',   name: 'Ezekiel',        slug: 'ezekiel',        testament: 'OT', chapters: 48,  group: 'Major Prophets' },
  { id: 'dn',   name: 'Daniel',         slug: 'daniel',         testament: 'OT', chapters: 12,  group: 'Major Prophets' },
  // Minor Prophets
  { id: 'ho',   name: 'Hosea',          slug: 'hosea',          testament: 'OT', chapters: 14,  group: 'Minor Prophets' },
  { id: 'jl',   name: 'Joel',           slug: 'joel',           testament: 'OT', chapters: 3,   group: 'Minor Prophets' },
  { id: 'am',   name: 'Amos',           slug: 'amos',           testament: 'OT', chapters: 9,   group: 'Minor Prophets' },
  { id: 'ob',   name: 'Obadiah',        slug: 'obadiah',        testament: 'OT', chapters: 1,   group: 'Minor Prophets' },
  { id: 'jon',  name: 'Jonah',          slug: 'jonah',          testament: 'OT', chapters: 4,   group: 'Minor Prophets' },
  { id: 'mi',   name: 'Micah',          slug: 'micah',          testament: 'OT', chapters: 7,   group: 'Minor Prophets' },
  { id: 'na',   name: 'Nahum',          slug: 'nahum',          testament: 'OT', chapters: 3,   group: 'Minor Prophets' },
  { id: 'hk',   name: 'Habakkuk',       slug: 'habakkuk',       testament: 'OT', chapters: 3,   group: 'Minor Prophets' },
  { id: 'zp',   name: 'Zephaniah',      slug: 'zephaniah',      testament: 'OT', chapters: 3,   group: 'Minor Prophets' },
  { id: 'hg',   name: 'Haggai',         slug: 'haggai',         testament: 'OT', chapters: 2,   group: 'Minor Prophets' },
  { id: 'zc',   name: 'Zechariah',      slug: 'zechariah',      testament: 'OT', chapters: 14,  group: 'Minor Prophets' },
  { id: 'ml',   name: 'Malachi',        slug: 'malachi',        testament: 'OT', chapters: 4,   group: 'Minor Prophets' },
  // ── NEW TESTAMENT ──────────────────────────────────────────────────────────
  // Gospels
